...
export const TRANSFORMERLENS_MODELS: ModelInfo[] = [
  ...
  // Stanford GPT-2 Models (Research)
  { id: "stanford-crfm/alias-gpt2-small-x21", name: "Stanford Alias GPT2-Small x21", family: "Stanford-GPT2", size: "124M" },
  { id: "stanford-crfm/battlestar-gpt2-small-x49", name: "Stanford Battlestar GPT2-Small x49", family: "Stanford-GPT2", size: "124M" },
  { id: "stanford-crfm/caprica-gpt2-small-x81", name: "Stanford Caprica GPT2-Small x81", family: "Stanford-GPT2", size: "124M" },
  { id: "stanford-crfm/darkmatter-gpt2-small-x343", name: "Stanford Darkmatter GPT2-Small x343", family: "Stanford-GPT2", size: "124M" },
  { id: "stanford-crfm/expanse-gpt2-small-x777", name: "Stanford Expanse GPT2-Small x777", family: "Stanford-GPT2", size: "124M" },
  { id: "stanford-crfm/arwen-gpt2-medium-x21", name: "Stanford Arwen GPT2-Medium x21", family: "Stanford-GPT2", size: "355M" },
  { id: "stanford-crfm/beren-gpt2-medium-x49", name: "Stanford Beren GPT2-Medium x49", family: "Stanford-GPT2", size: "355M" },
  { id: "stanford-crfm/celebrimbor-gpt2-medium-x81", name: "Stanford Celebrimbor GPT2-Medium x81", family: "Stanford-GPT2", size: "355M" },
  { id: "stanford-crfm/durin-gpt2-medium-x343", name: "Stanford Durin GPT2-Medium x343", family: "Stanford-GPT2", size: "355M" },
  { id: "stanford-crfm/eowyn-gpt2-medium-x777", name: "Stanford Eowyn GPT2-Medium x777", family: "Stanford-GPT2", size: "355M" },
  ...
  { id: "EleutherAI/pythia-70m-v0", name: "Pythia 70M v0", family: "Pythia", size: "70M" },
  { id: "EleutherAI/pythia-160m-v0", name: "Pythia 160M v0", family: "Pythia", size: "160M" },
  { id: "EleutherAI/pythia-410m-v0", name: "Pythia 410M v0", family: "Pythia", size: "410M" },
  { id: "EleutherAI/pythia-1b-v0", name: "Pythia 1B v0", family: "Pythia", size: "1B" },
  { id: "EleutherAI/pythia-1.4b-v0", name: "Pythia 1.4B v0", family: "Pythia", size: "1.4B" },
  { id: "EleutherAI/pythia-2.8b-v0", name: "Pythia 2.8B v0", family: "Pythia", size: "2.8B" },
  { id: "EleutherAI/pythia-6.9b-v0", name: "Pythia 6.9B v0", family: "Pythia", size: "6.9B" },
  { id: "EleutherAI/pythia-12b-v0", name: "Pythia 12B v0", family: "Pythia", size: "12B" },
  { id: "EleutherAI/pythia-70m-deduped-v0", name: "Pythia 70M (Deduped) v0", family: "Pythia", size: "70M" },
  { id: "EleutherAI/pythia-160m-deduped-v0", name: "Pythia 160M (Deduped) v0", family: "Pythia", size: "160M" },
  { id: "EleutherAI/pythia-410m-deduped-v0", name: "Pythia 410M (Deduped) v0", family: "Pythia", size: "410M" },
  { id: "EleutherAI/pythia-1b-deduped-v0", name: "Pythia 1B (Deduped) v0", family: "Pythia", size: "1B" },
  { id: "EleutherAI/pythia-1.4b-deduped-v0", name: "Pythia 1.4B (Deduped) v0", family: "Pythia", size: "1.4B" },
  { id: "EleutherAI/pythia-2.8b-deduped-v0", name: "Pythia 2.8B (Deduped) v0", family: "Pythia", size: "2.8B" },
  { id: "EleutherAI/pythia-6.9b-deduped-v0", name: "Pythia 6.9B (Deduped) v0", family: "Pythia", size: "6.9B" },
  { id: "EleutherAI/pythia-12b-deduped-v0", name: "Pythia 12B (Deduped) v0", family: "Pythia", size: "12B" },
  { id: "EleutherAI/pythia-160m-seed1", name: "Pythia 160M Seed 1", family: "Pythia", size: "160M" },
  { id: "EleutherAI/pythia-160m-seed2", name: "Pythia 160M Seed 2", family: "Pythia", size: "160M" },
  { id: "EleutherAI/pythia-160m-seed3", name: "Pythia 160M Seed 3", family: "Pythia", size: "160M" },

  // NeelNanda Research Models
  { id: "NeelNanda/SoLU_1L_v9_old", name: "SoLU 1L v9 (Old)", family: "NeelNanda-SoLU", size: "25M" },
  { id: "NeelNanda/SoLU_2L_v10_old", name: "SoLU 2L v10 (Old)", family: "NeelNanda-SoLU", size: "50M" },
  { id: "NeelNanda/SoLU_4L_v11_old", name: "SoLU 4L v11 (Old)", family: "NeelNanda-SoLU", size: "100M" },
  { id: "NeelNanda/SoLU_6L_v13_old", name: "SoLU 6L v13 (Old)", family: "NeelNanda-SoLU", size: "150M" },
  { id: "NeelNanda/SoLU_8L_v21_old", name: "SoLU 8L v21 (Old)", family: "NeelNanda-SoLU", size: "200M" },
  { id: "NeelNanda/SoLU_10L_v22_old", name: "SoLU 10L v22 (Old)", family: "NeelNanda-SoLU", size: "250M" },
  { id: "NeelNanda/SoLU_12L_v23_old", name: "SoLU 12L v23 (Old)", family: "NeelNanda-SoLU", size: "300M" },
  { id: "NeelNanda/SoLU_1L512W_C4_Code", name: "SoLU 1L 512W C4", family: "NeelNanda-SoLU", size: "25M" },
  { id: "NeelNanda/SoLU_2L512W_C4_Code", name: "SoLU 2L 512W C4", family: "NeelNanda-SoLU", size: "50M" },
  { id: "NeelNanda/SoLU_3L512W_C4_Code", name: "SoLU 3L 512W C4", family: "NeelNanda-SoLU", size: "75M" },
  { id: "NeelNanda/SoLU_4L512W_C4_Code", name: "SoLU 4L 512W C4", family: "NeelNanda-SoLU", size: "100M" },
  { id: "NeelNanda/SoLU_6L768W_C4_Code", name: "SoLU 6L 768W C4", family: "NeelNanda-SoLU", size: "150M" },
  { id: "NeelNanda/SoLU_8L1024W_C4_Code", name: "SoLU 8L 1024W C4", family: "NeelNanda-SoLU", size: "200M" },
  { id: "NeelNanda/SoLU_10L1280W_C4_Code", name: "SoLU 10L 1280W C4", family: "NeelNanda-SoLU", size: "250M" },
  { id: "NeelNanda/SoLU_12L1536W_C4_Code", name: "SoLU 12L 1536W C4", family: "NeelNanda-SoLU", size: "300M" },
  { id: "NeelNanda/GELU_1L512W_C4_Code", name: "GELU 1L 512W C4", family: "NeelNanda-GELU", size: "25M" },
  { id: "NeelNanda/GELU_2L512W_C4_Code", name: "GELU 2L 512W C4", family: "NeelNanda-GELU", size: "50M" },
  { id: "NeelNanda/GELU_3L512W_C4_Code", name: "GELU 3L 512W C4", family: "NeelNanda-GELU", size: "75M" },
  { id: "NeelNanda/GELU_4L512W_C4_Code", name: "GELU 4L 512W C4", family: "NeelNanda-GELU", size: "100M" },
  { id: "NeelNanda/Attn_Only_1L512W_C4_Code", name: "Attn-Only 1L 512W C4", family: "NeelNanda-AttnOnly", size: "25M" },
  { id: "NeelNanda/Attn_Only_2L512W_C4_Code", name: "Attn-Only 2L 512W C4", family: "NeelNanda-AttnOnly", size: "50M" },
  { id: "NeelNanda/Attn_Only_3L512W_C4_Code", name: "Attn-Only 3L 512W C4", family: "NeelNanda-AttnOnly", size: "75M" },
  { id: "NeelNanda/Attn_Only_4L512W_C4_Code", name: "Attn-Only 4L 512W C4", family: "NeelNanda-AttnOnly", size: "100M" },
  { id: "NeelNanda/Attn-Only-2L512W-Shortformer-6B-big-lr", name: "Attn-Only 2L Shortformer 6B", family: "NeelNanda-AttnOnly", size: "50M" },
  { id: "NeelNanda/SoLU_1L512W_Wiki_Finetune", name: "SoLU 1L 512W Wiki Finetune", family: "NeelNanda-SoLU", size: "25M" },
  { id: "NeelNanda/SoLU_4L512W_Wiki_Finetune", name: "SoLU 4L 512W Wiki Finetune", family: "NeelNanda-SoLU", size: "100M" },
  { id: "ArthurConmy/redwood_attn_2l", name: "Redwood Attn 2L", family: "Research", size: "50M" },

  // Llama Models
  { id: "llama-7b-hf", name: "Llama 1 7B (Unofficial HF)", family: "Llama", size: "7B" },
  { id: "llama-13b-hf", name: "Llama 1 13B (Unofficial HF)", family: "Llama", size: "13B" },
  { id: "llama-30b-hf", name: "Llama 1 30B (Unofficial HF)", family: "Llama", size: "30B" },
  { id: "llama-65b-hf", name: "Llama 1 65B (Unofficial HF)", family: "Llama", size: "65B" },
  ...
  { id: "roneneldan/TinyStories-1Layer-21M", name: "TinyStories 1 Layer 21M", family: "TinyStories", size: "21M" },
  { id: "roneneldan/TinyStories-2Layers-33M", name: "TinyStories 2 Layers 33M", family: "TinyStories", size: "33M" },
  ...
  { id: "roneneldan/TinyStories-Instuct-1Layer-21M", name: "TinyStories Instruct 1 Layer 21M", family: "TinyStories", size: "21M" },
  { id: "roneneldan/TinyStories-Instruct-2Layers-33M", name: "TinyStories Instruct 2 Layers 33M", family: "TinyStories", size: "33M" },
  ...
  { id: "Baidicoot/Othello-GPT-Transformer-Lens", name: "Othello-GPT", family: "Research", size: "25M" },
];
